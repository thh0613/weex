...
public class WXLogUtils {
  ...
  private static boolean sLogEnable; //是否打印log
  ...
  private static void log(String tag, String msg, LogLevel level){
    ...
    if (WXEnvironment.isApkDebugable() || sLogEnable) {
  ...
  public static void d(String tag, String msg) {
    ...
    if(!TextUtils.isEmpty(tag) && !TextUtils.isEmpty(msg)){
      ...
      if(WXEnvironment.isApkDebugable() || sLogEnable){//sLogLevel in debug mode is "LogLevel.DEBUG"
  ...
  public static void removeJsLogWatch(JsLogWatcher watcher) {
    if (!jsLogWatcherList.contains(watcher)) {
      jsLogWatcherList.remove(watcher);
    }
  }
