 ...
 */
  ...
  private native String nativeExecJSResult(String javascript, long callbackId);
  ...
  @Override
  public String execJSResult(String javascript) {
    return nativeExecJSResult(javascript, ResultCallbackManager.generateCallbackId(new ResultCallback() {
      @Override
      public void onReceiveResult(Object result) {
        Log.e("🐷🐷","onReceiveResult: " + new String((byte[]) result));
      }
    }));
  }
