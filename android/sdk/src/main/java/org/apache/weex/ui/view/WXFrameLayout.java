...
public class WXFrameLayout extends BaseFrameLayout implements WXGestureObservable,IRenderStatus<WXDiv>,IRenderResult<WXDiv>{
  ...
  public WXFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
  }

  public WXFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
