...
// console log 日志
#define LOGCONSOLE_TAG(TAG, format, ...) WEEX_CORE_LOG(WeexCore::LogLevel::Console, TAG, format, ##__VA_ARGS__)
#define LOGCONSOLE(format, ...) LOGD_TAG(WEEX_CORE_LOG_TAG, format, ##__VA_ARGS__)
